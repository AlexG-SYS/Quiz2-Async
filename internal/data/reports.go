...
// Generate is the potentially-slow, work-intensive step that the whole
// async architecture exists to keep off the HTTP request path. It is only
// ever called from processNextReportJob (worker.go), never from a
// handler.
