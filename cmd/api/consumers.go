...
// a single INSERT, so unlike report creation it does not need a
// job/worker. It exists mainly so requests have a real
// consumer_id to submit report jobs against.
